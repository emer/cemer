...
./nb_thread 25 5000 0 5 0 100 -algo=0 -header ${1} ${2} ${3} ${4} ${5}
./nb_thread 25 5000 1 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5} 
./nb_thread 25 5000 2 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}
./nb_thread 25 5000 4 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}

./nb_thread 100 1000 0 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}
./nb_thread 100 1000 1 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5} 
./nb_thread 100 1000 2 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}
./nb_thread 100 1000 4 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}

./nb_thread 625 100 0 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}
./nb_thread 625 100 1 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5} 
./nb_thread 625 100 2 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}
./nb_thread 625 100 4 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}

./nb_thread 1000 50 0 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}
./nb_thread 1000 50 1 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5} 
./nb_thread 1000 50 2 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}
./nb_thread 1000 50 4 5 0 100 -algo=0  ${1} ${2} ${3} ${4} ${5}
