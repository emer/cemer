...
# this is a script file for running vis_bench_sm.proj
...
# ./run_vis_bench_sm.sh n_threads=2 thread_alloc_pct=0 thread_nibble_chunk=8 thread_compute_thr=0.5 thread_min_units=1000 tag=_mac_mbp_216ghz_thr2alc0nib8thr5

# a basic run is:
# ./run_vis_bench_sm.sh n_threads=2 tag=_mac_mbp2_702_th2
...
echo " "
echo "=============================================================="
echo "vis_bench_sm -- small size vision model, for 1 epoch of 100 patterns"
$exe -nogui -ni -p vis_bench_sm.proj epochs=1 $*
