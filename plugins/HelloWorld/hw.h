...
private:
  void	Copy_(const HelloBase& cp) {min_max = cp.min_max;}
    // Allows this object to be copied -- put local members copy into Copy_
    // you can also use the easier macro: SIMPLE_COPY(HelloBase)
  void	Initialize() {}
  void	Destroy() {}
};
