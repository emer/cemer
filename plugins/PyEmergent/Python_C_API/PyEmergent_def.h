#ifndef PYEMERGENT_DEF_H
#define PYEMERGENT_DEF_H
...
// PYEMERGENT_API macro so that your plugin will compile on Windows. Published plugins
...
// All files within this DLL are compiled with the PYEMERGENT_EXPORTS pre-processor symbol
...
// PYEMERGENT_API functions as being imported from a dll, whereas this dll sees symbols
// defined with this macro as being exported.
#if ((defined(_WIN32) && defined(_MSC_VER)) && (!defined(__MAKETA__)))
# ifdef PyEmergent_EXPORTS
#   define PYEMERGENT_API __declspec(dllexport)
# else
#   define PYEMERGENT_API __declspec(dllimport)
# endif
#else 
# define PYEMERGENT_API
#endif

#undef QT_SHARED                             // Already defined in config.h.
#include "PyEmergent_TA_type.h" 

#endif // PYEMERGENT_DEF_H
