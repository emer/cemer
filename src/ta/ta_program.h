...
public:
  ...
  virtual void		LoadFromProgLib(ProgLibs library = SEARCH_LIBS, const String& file_nm="");
  // #MENU #MENU_ON_Object #MENU_CONTEXT load the program from the program library -- file name = object name unless new file_nm is specified
...
public: // XxxGui versions provide feedback to the usbool no_gui = falseer
  virtual void		ViewScript();
    // #MENU #MENU_CONTEXT #BUTTON view the css script generated by the program
