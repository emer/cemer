...
NameValue @[3] {\n\
name=\"con_spec\";\n\
value=\"{type=SoftClConSpec: spec=NULL: }\";\n\
};\n\
};\n\
};\n\
TypeDefault @[1] {\n\
...
NameValue @[0] {\n\
name=\"unit_spec\";\n\
value=\"{type=SoftClUnitSpec: spec=NULL: }\";\n\
};\n\
NameValue @[1] {\n\
name=\"spec\";\n\
value=\"{type=SoftClLayerSpec: spec=NULL: }\";\n\
};\n\
};\n\
};\n\
};\n\
