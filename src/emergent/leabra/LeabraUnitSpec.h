...
public:
  ...
  float      mod_thr;     // #CONDSHOW_ON_on&&role:SUPER #MIN_0 threshold on LAYER level maximum deep_mod_net before deep mod is applied -- if not receiving even this amount of overall input from deep_mod sender, then do not use the deep_mod_net to drive deep_mod and deep_lrn values -- only for SUPER units
