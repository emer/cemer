...
public:
  ...
  bool       trc_p_clamp;    // #CONDSHOW_ON_on&&role:TRC clamp the plus-phase trc activation to the computed netinput directly, instead of using dynamic activation value
