...
public:
  ...
  float         err_min;        // #DEF_0.04 #CONDSHOW_ON_err_mod minimum layer.cos_diff_avg_lrn value (for non-zero cases) -- ensures a minimum amount of self-organizing learning 
