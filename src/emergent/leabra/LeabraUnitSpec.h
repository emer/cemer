...
public:
  ...
  bool          super_d5b_off;  // #CONDSHOW_ON_on turn off the extra super netinput whenever cifer deep5b projections are active -- an alternative / additional compensation mechanism like ti_rescale
