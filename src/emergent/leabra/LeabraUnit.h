...
public:
  ...
  float       ctxt_scale;      // #NO_SAVE #EXPERT #CAT_UnitVar TI context rescaling factor -- needed for rescaling ti_ctxt to compensate for variable deep5b input on different quarters
