...
void CtLeabraUnitSpec::Compute_CtCycle(CtLeabraUnit* u, CtLeabraLayer*, CtLeabraNetwork*) {
...
void CtLeabraUnitSpec::Compute_dWt_impl(LeabraUnit* u, LeabraLayer*, LeabraNetwork* net) {
...
void CtLeabraNetwork::Cycle_Run() {
  inherited::Cycle_Run();
  Compute_CtCycle();
  // program code needs to do this after incrementing cycle++:
//   if(cycle % cycles_per_tick == 0) {
//     tick++;
//     Compute_dWt();
//   }
}
