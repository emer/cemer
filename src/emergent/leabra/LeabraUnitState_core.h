...
//{
  ...
  float      spike_int;      // #CAT_Activation time-averaged spike interval -- updated after every spike -- this is then used in computing the rate code relative to an expected maximum firing rate
  ...
  float      gc_kna_f;       // #NO_SAVE #CAT_Activation fast time constant sodium-gated potassium channel activation -- drives adapatation -- fast time constant
  float      gc_kna_m;       // #NO_SAVE #CAT_Activation medium time constant sodium-gated potassium channel activation -- drives adapatation -- medium time constant
  float      gc_kna_s;       // #NO_SAVE #CAT_Activation slow time constant sodium-gated potassium channel activation -- drives adapatation -- slow time constant
