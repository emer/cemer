...
public:
  ...
  float      margin;         // #CAT_Activation is this unit at the margin of the attractor state of the network, as determined by layer spec margin thresholds?  zeros indicate non-marginal state, negative numbers are low-margin and positive numbers are high-margin
