...
public:
  ...
  float      thal;           // #NO_SAVE #VIEW_HOT #CAT_Activation thalamic activation value, driven by a ThalSendUnitSpec -- used by cifer params in LeabraUnitSpec and MatrixConSpecs, and possibly other specs, to respond to thalamic inputs
  float      thal_prv;       // #NO_SAVE #CAT_Activation previous thalamic activation value (updated at end of phase or trial depending on cifer.phase), driven by a ThalSendUnitSpec -- used by cifer params in LeabraUnitSpec and MatrixConSpecs, and possibly other specs, to respond to thalamic inputs
