...
public:
  ...
  float      act_lrn;        // #VIEW_HOT #CAT_Activation activation value that drives learning -- can have function relative to standard activation value used in communicating with other neurons
