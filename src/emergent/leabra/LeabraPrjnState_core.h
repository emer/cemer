...
// {
  ...
  LEABRA_AVG_MAX  am_err_dwt;         // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Learning maximum, average error-driven weight change across this projection, this trial -- only computed if conspec dwt_norm.stats is on 
  LEABRA_AVG_MAX  am_bcm_dwt;         // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Learning maximum, average hebbian BCM weight change across this projection, this trial -- only computed if conspec dwt_norm.stats is on 
  LEABRA_AVG_MAX  am_dwt;             // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Learning maximum, average overall weight change across this projection, this trial -- only computed if conspec dwt_norm.stats is on 
  float         prjn_dwnorm;         // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Learning projection-level dwt_norm normalization factor -- slowly decaying max(abs(dwt)) across projection -- only updated if conspec dwt_norm.level is PRJN
  ...
  INLINE void     Init_Weights_State() {
    scale_eff = 1.0f; am_err_dwt.InitVals(); am_bcm_dwt.InitVals(); am_dwt.InitVals();
    prjn_dwnorm = 0.0f; 
  }
