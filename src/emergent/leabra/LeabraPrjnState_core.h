...
float           netin_avg;           // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Statistic average netinput values for the recv projections into this layer
  ...
  float         hi_wt_avg_max;        // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Statistic maximum average weight above wt_bal.hi_thr across recv con state of units with this projection -- only computed if weight balance mechanism is on and network.lstats.wt_bal is on
  float         hi_wt_avg_avg;        // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Statistic average of weight averages above wt_bal.hi_thr across recv con state of units with this projection -- only computed if weight balance mechanism is on and network.lstats.wt_bal is on
  ...
  INLINE void     Init_Stats() {
    ...
    hi_wt_avg_max = 0.0f;    hi_wt_avg_avg = 0.0f;
  }
