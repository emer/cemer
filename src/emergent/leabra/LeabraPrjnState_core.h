...
// {
  ...
  LEABRA_AVG_MAX  am_err_dwt;         // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Learning maximum, average error-driven weight change across this projection, this trial
  LEABRA_AVG_MAX  am_bcm_dwt;         // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Learning maximum, average hebbian BCM weight change across this projection, this trial
  LEABRA_AVG_MAX  am_dwt;             // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Learning maximum, average overall weight change across this projection, this trial
