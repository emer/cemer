...
#ifndef ECinUnitSpec_h
#define ECinUnitSpec_h 1
...
eTypeDef_Of(ECinUnitSpec);

class E_API ECinUnitSpec : public LeabraUnitSpec {
...
public:
 ...
 TA_SIMPLE_BASEFUNS(ECinUnitSpec);
private:
  void Initialize()  { };
  void Destroy()     { };
};

#endif // ECinUnitSpec_h
