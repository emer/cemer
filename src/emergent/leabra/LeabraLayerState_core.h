...
// {
  ...
  LEABRA_AVG_MAX     laygp_netin;    // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Activation average, maximum net input values for the layer group
  LEABRA_AVG_MAX     laygp_acts_eq;  // #NO_SAVE #GUI_READ_ONLY #SHOW #CAT_Activation average, maximum act_eq values for the layer group
