...
#include "InvertLayerSpec.h"

#include <LeabraNetwork>
#include <LayerActUnitSpec>

TA_BASEFUNS_CTORS_DEFN(InvertLayerSpec);


void InvertLayerSpec::Initialize() {
  Defaults_init();
}

void InvertLayerSpec::Defaults_init() {
}

bool InvertLayerSpec::CheckConfig_Layer(Layer* ly, bool quiet) {
...
void InvertLayerSpec::Compute_ActFmSource(LeabraLayer* lay, LeabraNetwork* net) {
...
void InvertLayerSpec::Compute_CycleStats(LeabraLayer* lay, LeabraNetwork* net, int thread_no) {
