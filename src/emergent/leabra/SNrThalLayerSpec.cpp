...
void SNrThalLayerSpec::ResetMntCount(LeabraLayer* lay, int gp_idx) {
  // resets to -1 starting point for a single stripe
...
void SNrThalLayerSpec::Compute_CycleStats(LeabraLayer* lay, LeabraNetwork* net, int thread_no) {
