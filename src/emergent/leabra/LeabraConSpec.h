...
INHERITED(SpecMemberBase)
public:
  bool          avg_send;       // #DEF_false use experimental average-sending-activation in learning rule, instead of full CHL style synaptic co-products
  float         avg_s_pct;      // #CONDSHOW_ON_avg_send what percent of sender average should be short-term vs. long-term activation
