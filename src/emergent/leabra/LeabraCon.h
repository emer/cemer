...
public:
  ...
  float         dwnorm;         // #NO_SAVE #AUTO_SCALE dwt normalization factor -- reset to max of abs value of dwt, decays slowly down over time -- serves as an estimate of variance in weight changes over time
  ...
  LeabraCon() { moment = dwnorm = fwt = swt = 0.0f; scale = wb_inc = wb_dec = 1.0f; }
