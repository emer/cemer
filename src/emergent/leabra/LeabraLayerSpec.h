...
public:
  ...
  bool          thr_act;        // #CONDSHOW_OFF_net_thr:0 #DEF_true if true, net_thr is applied in computing the average activations in addition to average net inputs -- those units with low net inputs are just ignored from the inhibition computation effectively 
