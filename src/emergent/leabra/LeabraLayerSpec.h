...
public:
  ...
  bool          thr_act;        // #CONDSHOW_OFF_net_thr:0 #DEF_false if true, net_thr is applied in computing the average activations in addition to average net inputs -- those units with low net inputs are just ignored from the inhibition computation effectively -- this changes the inhibition dynamics significantly and is likely only useful in very specialized cases
