...
#ifndef FromGpRowColPrjnSpec_h
#define FromGpRowColPrjnSpec_h 1
...
eTypeDef_Of(FromGpRowColPrjnSpec);

class E_API FromGpRowColPrjnSpec : public GpCustomPrjnSpecBase {
  // receive projection from a range of rows or columns of unit groups within sending layer -- projects to entire receiving layer
...
public:
  ...
  TA_SIMPLE_BASEFUNS(FromGpRowColPrjnSpec);
private:
  void Initialize();
  void Destroy()     { };
};

#endif // FromGpRowColPrjnSpec_h
