...
public:
  ...
  float		go_bias;	// #DEF_0 #MIN_0 how strong of a performance bias to apply to induce units to fire a Go during a random go firing episode -- this is like the gate_bias -- definitely doesn't seem to work -- currently investigating
