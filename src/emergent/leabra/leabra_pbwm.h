...
public:
  ...
  float		leak;		// #DEF_0.5 #MIN_0 a leak-like term for the netinput computation -- just a constant added to the denominator in computing net input: (go - nogo) / (go + nogo + leak)
