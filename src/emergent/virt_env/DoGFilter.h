...
public:
  ...
  float		gain;		// #CONDSHOW_ON_on #DEF_8;4.1;4.4 overall gain multiplier applied after filtering -- only relevant if not using renormalization (otherwize it just gets renormed away)
