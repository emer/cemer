...
// this implementation is based on the old version of WeightsToTable
//bool WtBasedRF::ComputeV2RF(Network* net, DataTable* dt_trg, DataTable* wts, Layer* tlay, Layer* slay, V1RetinaProc* rproc, float wt_threshold) {
//  network = net;
//  dt_trg_rf = dt_trg;
//  trg_layer_wts = wts;
...
//          snd_layer_log_pos.x = (snd_layer_log_pos.x/dim_0) * space;
//          snd_layer_log_pos.y = (snd_layer_log_pos.y/dim_1) * space;
//          
//          // write the sum values to the dt_trg_rf table
