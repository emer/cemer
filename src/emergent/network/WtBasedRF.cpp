...
bool WtBasedRF::ComputeV2RF_V2(Network* net, DataTable* dt_trg, DataTable* wts, Layer* tlay, Layer* slay, V1RetinaProc* rproc, float wt_threshold) {
  network = net;
  dt_trg_rf = dt_trg;
  trg_layer_wts = wts;
  trg_layer = tlay;
