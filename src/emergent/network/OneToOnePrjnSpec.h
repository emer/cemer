...
// {
  ...
  INIMPL virtual void ConnectRecvGp_impl(PRJN_STATE* prjn, NETWORK_STATE* net, int make_cons); // recv is using groups
  INIMPL virtual void ConnectSendGp_impl(PRJN_STATE* prjn, NETWORK_STATE* net, int make_cons); // send is using groups
