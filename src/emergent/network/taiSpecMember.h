...
protected:
  taiWidget*     GetArbitrateDataRep(IWidgetHost* host_, taiWidget* par, QWidget* gui_parent_, int flags_, MemberDef* mbr_) override;
  void         GetArbitrateImage(taiWidget* dat, const void* base) override;
  void         GetArbitrateMbrValue(taiWidget* dat, void* base, bool& first_diff) override;
};
