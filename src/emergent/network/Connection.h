...
// the connection is managed fully by the ConSpec and the ConState
...
// of this object is used by the ConState to manage the connection memory,
...
public:
  float        wt;             // #VIEW_HOT #SAVE synaptic weight of connection (Alt + Mouse Click to see weight for any unit)
  float        dwt;            // #VIEW_HOT #AUTO_SCALE #NO_SAVE change in synaptic weight as computed by learning mechanism
