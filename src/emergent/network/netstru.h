...
public:
  ...
  bool		send_netin;	// #NO_SAVE NOTE: not saved -- initialized from user prefs.  should the Send_Netin call be threaded or not?  this can actually be slower on some machines
