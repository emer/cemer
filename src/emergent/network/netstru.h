...
//  calling an inner extensible virtual _impl
  ...
  // #MENU_BUTTON #MENU_ON_NetView #MENU_SEP_BEFORE #CAT_Structure record the network structure to given data table, including names of layers and layer groups, sizes, and where each layer receives projections from and sends projections to
