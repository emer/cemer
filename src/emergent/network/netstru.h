...
public:
  ...
  // #CAT_Structure #BUTTON update the name of projection to reflect any changes in where it receives from
...
//  calling an inner extensible virtual _impl
  ...
  virtual void	NetStructToTable(DataTable* dt);
  // #MENU_BUTTON #MENU_ON_NetView #MENU_SEP_BEFORE #CAT_Structure record the network structure to given data table, including names of layers and layer groups, sizes and positions, and where each layer receives projections from and sends projections to
