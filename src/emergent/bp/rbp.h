...
INHERITED(BpConSpec)
public:
  inline void 	Compute_dWt(ConState* cg, Unit* ru, Network* net) override;
...
inline void RBpConSpec::Compute_dWt(ConState* cg, Unit* ru, Network* net) {
...
inline void SymRBpConSpec::Compute_dWt(ConState* cg, Unit* ru, Network* net) {
  const float ru_dEdNet = ((BpUnit*)ru)->dEdNet;
