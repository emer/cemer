...
class E_API BpTrial : public TrialProcess {
...
class E_API NormDotProd_Stat : public Stat {
...
class E_API VecCor_Stat : public Stat {
...
class E_API NormVecLen_Stat : public Stat {
...
class E_API RBpTrial : public BpTrial {
...
class E_API RBpSequence : public SequenceProcess {
...
class E_API RBpSE_Stat : public SE_Stat {
...
class E_API APBpSettle : public SettleProcess {
...
class E_API APBpTrial : public TrialProcess {
...
class E_API APBpMaxDa_De : public Stat {
...
class E_API V3BpProject : public V3ProjectBase {
