...
{
  QObject::connect(m_specularParameter, &Qt3DRender::QParameter::valueChanged, this, &T3PerVertexTransMaterial::handleSpecularChanged);
  QObject::connect(m_shininessParameter, &Qt3DRender::QParameter::valueChanged, this, &T3PerVertexTransMaterial::handleShininessChanged);
...
void T3PerVertexTransMaterial::handleSpecularChanged(const QVariant &var)
{
  emit specularChanged(var.value<QColor>());
}

void T3PerVertexTransMaterial::handleShininessChanged(const QVariant &var)
{
