...
/*!
  \class Qt3D::QTransparentMaterial
  \brief The QTransparentMaterial class provides a default implementation of the trans lighting effect.
  \inmodule Qt3DRenderer
  \since 5.5

  The trans lighting effect is based on the combination of 3 lighting components ambient, diffuse and specular.
...
/*!
  \fn Qt3D::QTransparentMaterial::QTransparentMaterial(QNode *parent)

  Constructs a new QTransparentMaterial instance with parent object \a parent.
*/
