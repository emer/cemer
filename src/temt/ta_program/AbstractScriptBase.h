...
taTypeDef_Of(AbstractScriptBase);
...
public:
  ...
  // #MENU #LABEL_Compile #MENU_ON_Actions #ARGC_0 #ENABLE_OFF_script_compiled:true compile script from source into internal runnable format;\n 'true' if compiled, 'false' if not or if deferred due to being in readline
