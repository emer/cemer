...
public:
  ...
  taBaseRef     object_scope;    // #CONDSHOW_ON_var_type:T_Object #TYPE_taBase #SCOPE_taProject for object pointers, if this is set (non NULL), then restrict selection of objects to those that are under this object -- can make it easier for the user to find the right kind of object to select for this variable
