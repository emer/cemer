...
public:
  ...
  void          Enable();
  // #MENU #DYN1 #ENABLE_OFF_enabled enable existing disabled breakpoint
  void          Disable();
  // #MENU #DYN1 #ENABLE_ON_enabled disable existing breakpoint but don't delete the breakpoint
