...
class TA_API Program_Group : public taGroup<Program> {
  // ##EXT_progp ##FILETYPE_ProgramGroup #CAT_Program ##EXPAND_DEF_2 ##EXPAND_USER_DEF_1 a collection of programs sharing common global variables and a control panel interface
