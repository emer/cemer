...
#ifndef taiWidgetWikiChooser_h
#define taiWidgetWikiChooser_h 1
...
class TA_API taiWidgetWikiChooser : public taiWidgetListElChooser {
// for prog lib items
...
public:
  ...
  taiWidgetWikiChooser(TypeDef* typ, IWidgetHost* host, taiWidget* par,
