...
public:
  ...
  QTreeWidgetItem*      selItem() const {return m_selItem;}
...
protected:
  ...
  virtual void          GetColumnSpecifier(String specifier, int& column) const;
  // set column to column number if column name or number matches
