...
#include "taiWidgetLinkListEditButton.h"
#include <taiMethod>
#include <taiWidgetMethod>


taiWidgetLinkListEditButton::taiWidgetLinkListEditButton
(void* base, TypeDef* tp, IWidgetHost* host_, taiWidget* par, QWidget* gui_parent_, int flags_)
: taiWidgetListEditButton(base, tp, host_, par, gui_parent_, flags_)
{
}

void taiWidgetLinkListEditButton::GetMethMenus() {
