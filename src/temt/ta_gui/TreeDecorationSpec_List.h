...
#ifndef TreeDecorationSpec_List_h
#define TreeDecorationSpec_List_h 1

// parent includes:
#include <TreeDecorationSpec>
#include <taList>
...
taTypeDef_Of(TreeDecorationSpec_List);
...
#endif // TreeDecorationSpec_List_h
