...
#include "taiWidgetDelegateControlPanel.h"
...
QTableWidgetItem* /*taiWidgetDelegateControlPanel::*/ItemFromIndex(QTableWidget* tw,
...
taiWidgetDelegateControlPanel::taiWidgetDelegateControlPanel(ControlPanel* sele_,
  taiEditorOfControlPanelFast* sedh_)
:inherited(sedh_)
{
  sele = sele_;
  sedh = sedh_;
...
QWidget* taiWidgetDelegateControlPanel::createEditor(QWidget* parent,
...
void taiWidgetDelegateControlPanel::GetImage() const {
  if (!dat) return;
  edh->Updating(true);
...
void taiWidgetDelegateControlPanel::GetValue() const {
  if (!dat) return;
...
bool taiWidgetDelegateControlPanel::IndexToMembBase(const QModelIndex& index,
