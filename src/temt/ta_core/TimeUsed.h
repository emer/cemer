...
class TA_API TimeUsed : public taNBase {
  // #STEM_BASE #INLINE ##CAT_Program ##CHOOSE_AS_MEMBER #OBSOLETE OBSOLETE: use TimeUsedHR instead -- only here for backward compatibility -- computes amount of time used for a given process: start the timer at the start, then do EndTimer and it computes the amount used
INHERITED(taNBase)
public:
