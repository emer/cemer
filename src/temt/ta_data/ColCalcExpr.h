...
public:
  ...
  DataCol*         col_lookup;  // #NULL_OK #NO_EDIT #NO_SAVE #FROM_LIST_data_cols #NO_UPDATE_POINTER #NO_FIND lookup a program variable and add it to the current expression (this field then returns to empty/NULL)
