...
#include "taiEditorOfControlPanelFast.h"
...
taiEditorOfControlPanelFast::taiEditorOfControlPanelFast(void* base, TypeDef* td,
...
taiEditorOfControlPanelFast::~taiEditorOfControlPanelFast() {
  delete sed; // hope it's ref is deleted too!
  sed = NULL;
}

void taiEditorOfControlPanelFast::Initialize()
{
  tw = NULL;
  sele = NULL;
  sel_edit_mbrs = true; // note: we don't actually select members, just for removal
  sed = new taiWidgetDelegateControlPanel(sele, this);
}

void taiEditorOfControlPanelFast::Constr_Body_impl() {
}

void taiEditorOfControlPanelFast::Constr_Box() {
...
void taiEditorOfControlPanelFast::ClearBody_impl() {
...
void taiEditorOfControlPanelFast::Constr_Widget_Labels() {
...
void taiEditorOfControlPanelFast::GetImage_Item(int row) {
  if (row < 0) return;
...
void taiEditorOfControlPanelFast::GetImage_Membs_def() {
...
void taiEditorOfControlPanelFast::DoRemoveSelEdit() {
...
void taiEditorOfControlPanelFast::FillLabelContextMenu_SelEdit(QMenu* menu,
  int& last_id)
{
  int sel_item_index = -1;
  sele->mbrs.FindItemBase(sel_item_base, sel_item_mbr, sel_item_index);
...
void taiEditorOfControlPanelFast::GetValue_Membs_def() {
  sed->GetValue();
}

void taiEditorOfControlPanelFast::tw_currentCellChanged(int row,
...
void taiEditorOfControlPanelFast::tw_customContextMenuRequested(const QPoint& pos)
{
