...
#ifndef taiWidgetTokenPtr_h
#define taiWidgetTokenPtr_h 1
...
class TA_API taiWidgetTokenPtr : public taiWidgetItemPtr {
...
public:
  ...
  taiWidgetTokenPtr(TypeDef* typ_, IWidgetHost* host,
