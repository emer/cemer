...
class TA_API taiArgTypeOfListOnObjBasePtr : public taiArgTypeOftaBasePtr {
  // for taBase pointers in groups with ARG_IN_OBJ
  TAI_ARGTYPE_SUBCLASS(taiArgTypeOfListOnObjBasePtr, taiArgTypeOftaBasePtr);
public:
