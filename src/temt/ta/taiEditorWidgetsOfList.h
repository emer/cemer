...
#ifndef taiEditorWidgetsOfList_h
#define taiEditorWidgetsOfList_h 1
...
class TA_API taiEditorWidgetsOfList : public taiEditorWidgetsMulti {
...
//  MemberSpace         lst_membs;      // list of members
  ...
  taiEditorWidgetsOfList(void* base, TypeDef* typ_, bool read_only_ = false,
        bool modal_ = false, QObject* parent = 0); //(TypeDef* tp, void* base);
  taiEditorWidgetsOfList()                             { };
  ~taiEditorWidgetsOfList(); //
...
#endif // taiEditorWidgetsOfList_h
