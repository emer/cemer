...
#ifndef taiWidgetTypeHierMenu_h
#define taiWidgetTypeHierMenu_h 1
...
class TA_API taiWidgetTypeHierMenu : public taiWidget {
...
public:
  ...
  taiWidgetTypeHierMenu(taiWidgetActions::RepType rt, int ft, TypeDef* typ_, IWidgetHost* host, taiWidget* par,
    QWidget* gui_parent_, int flags_ = 0);
  taiWidgetTypeHierMenu(taiWidgetMenu* existing_menu, TypeDef* typ_, IWidgetHost* host, taiWidget* par,
    QWidget* gui_parent_, int flags_ = 0);
  ~taiWidgetTypeHierMenu(); //
protected:
