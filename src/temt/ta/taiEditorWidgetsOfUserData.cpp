...
#include "taiEditorWidgetsOfUserData.h"
...
taiEditorWidgetsOfUserData::taiEditorWidgetsOfUserData(void* base, TypeDef* td,
...
taiEditorWidgetsOfUserData::~taiEditorWidgetsOfUserData() {
  delete udd; // hope it's ref is deleted too!
  udd = NULL;
}

void taiEditorWidgetsOfUserData::Initialize()
{
...
void taiEditorWidgetsOfUserData::Constr_impl() {
...
void taiEditorWidgetsOfUserData::Constr_Body_impl() {
}

void taiEditorWidgetsOfUserData::Constr_Box() {
...
void taiEditorWidgetsOfUserData::ClearBody_impl() {
  // note: we don't nuke control, we just clear it
  tw->clear();
}

void taiEditorWidgetsOfUserData::Constr_Data_Labels() {
...
void taiEditorWidgetsOfUserData::GetImage_Item(int row) {
...
void taiEditorWidgetsOfUserData::GetImage_Membs_def() {
...
void taiEditorWidgetsOfUserData::Constr_Methods_impl() {
  inherited::Constr_Methods_impl();
  Insert_Methods();
}

void taiEditorWidgetsOfUserData::SigLinkRecv(taSigLink* dl, int sls, void* op1, void* op2) {
...
void taiEditorWidgetsOfUserData::DoDeleteUserDataItem() {
   // removes the sel_item_index item
  if (udil->RemoveLeafEl(sel_item_base)) {
  }
  else
    taMisc::DebugInfo("taiEditorWidgetsOfUserData::DoDeleteUserDataItem: could not find item");
}

void taiEditorWidgetsOfUserData::DoRenameUserDataItem() {
...
void taiEditorWidgetsOfUserData::FillLabelContextMenu_SelEdit(QMenu* menu,
  int& last_id)
{
...
UserDataItemBase* taiEditorWidgetsOfUserData::GetUserDataItem(int row) {
...
void taiEditorWidgetsOfUserData::GetValue_Membs_def() {
  udd->GetValue();
  if(udil && udil->owner)
    udil->owner->UpdateAfterEdit(); // update owner too
}

void taiEditorWidgetsOfUserData::tw_currentCellChanged(int row,
...
void taiEditorWidgetsOfUserData::tw_customContextMenuRequested(const QPoint& pos)
{
...
void taiEditorWidgetsOfUserData::tw_itemChanged(QTableWidgetItem* item)
{
