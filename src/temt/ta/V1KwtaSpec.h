...
public:
  ...
  int           n_itr;  // #CONDSHOW_ON_mode:FFFB #DEF_10:40 number of iterations to perform on fffb inhib
  float         fb_dt;  // #HIDDEN #NO_SAVE #DEF_0.3 time constant for integrating fb inhib
