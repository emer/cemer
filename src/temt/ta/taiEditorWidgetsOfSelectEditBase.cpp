...
#include "taiEditorWidgetsOfSelectEditBase.h"
#include <SelectEdit>
#include <taiMethod>
#include <taiAction>
...
taiEditorWidgetsOfSelectEditBase::taiEditorWidgetsOfSelectEditBase(void* base, TypeDef* td,
...
taiEditorWidgetsOfSelectEditBase::~taiEditorWidgetsOfSelectEditBase() {
}

void taiEditorWidgetsOfSelectEditBase::Initialize()
{
...
void taiEditorWidgetsOfSelectEditBase::Constr_Body() {
  if (rebuild_body) {
    meth_el.Reset();
  }
...
void taiEditorWidgetsOfSelectEditBase::Constr_Methods_impl() {
...
taBase* taiEditorWidgetsOfSelectEditBase::GetMembBase_Flat(int idx) {
  return sele->mbrs.GetBase_Flat(idx);
}

taBase* taiEditorWidgetsOfSelectEditBase::GetMethBase_Flat(int idx) {
  return sele->mths.GetBase_Flat(idx);
}


void taiEditorWidgetsOfSelectEditBase::mnuRemoveMember_select(int idx) {
  sele->RemoveField(idx);
}

void taiEditorWidgetsOfSelectEditBase::mnuRemoveMethod_select(int idx) {
  sele->RemoveFun(idx);
}
