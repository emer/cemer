...
#ifndef iT3TabViewer_h
#define iT3TabViewer_h 1
...
class TA_API iT3TabViewer : public iFrameViewer {
...
public:
  ...
  inline T3TabViewer*  viewer() {return (T3TabViewer*)m_viewer;}
  ...
  iT3TabViewer(T3TabViewer* viewer_, QWidget* parent = NULL);
  ~iT3TabViewer(); //
