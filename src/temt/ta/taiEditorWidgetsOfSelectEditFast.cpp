...
#include "taiEditorWidgetsOfSelectEditFast.h"
#include <SelectEdit>
...
taiEditorWidgetsOfSelectEditFast::taiEditorWidgetsOfSelectEditFast(void* base, TypeDef* td,
...
taiEditorWidgetsOfSelectEditFast::~taiEditorWidgetsOfSelectEditFast() {
  delete sed; // hope it's ref is deleted too!
  sed = NULL;
}

void taiEditorWidgetsOfSelectEditFast::Initialize()
{
  tw = NULL;
  sele = NULL;
...
void taiEditorWidgetsOfSelectEditFast::Constr_Body_impl() {
}

void taiEditorWidgetsOfSelectEditFast::Constr_Box() {
...
void taiEditorWidgetsOfSelectEditFast::ClearBody_impl() {
...
void taiEditorWidgetsOfSelectEditFast::Constr_Data_Labels() {
...
void taiEditorWidgetsOfSelectEditFast::GetImage_Item(int row) {
  if (row < 0) return;
...
void taiEditorWidgetsOfSelectEditFast::GetImage_Membs_def() {
...
void taiEditorWidgetsOfSelectEditFast::DoRemoveSelEdit() {
  ...
  if (sel_item_index >= 0) {
    ...
    taMisc::DebugInfo("taiEditorWidgetsOfSelectEditFull::DoRemoveSelEdit: could not find item");
}

void taiEditorWidgetsOfSelectEditFast::FillLabelContextMenu_SelEdit(QMenu* menu,
  int& last_id)
{
  int sel_item_index = -1;
  sele->mbrs.FindItemBase(sel_item_base, sel_item_mbr, sel_item_index);
...
void taiEditorWidgetsOfSelectEditFast::GetValue_Membs_def() {
  sed->GetValue();
}

void taiEditorWidgetsOfSelectEditFast::tw_currentCellChanged(int row,
...
void taiEditorWidgetsOfSelectEditFast::tw_customContextMenuRequested(const QPoint& pos)
{
