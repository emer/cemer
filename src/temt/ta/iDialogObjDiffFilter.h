...
#ifndef iDialogObjDiffFilter_h
#define iDialogObjDiffFilter_h 1
...
class TA_API iDialogObjDiffFilter : public iDialog {
  // ##NO_TOKENS ##NO_CSS ##NO_MEMBERS filter dialog for obj diff browser
INHERITED(iDialog)
  Q_OBJECT
public:

  static iDialogObjDiffFilter* New(int font_type, QWidget* par_window_ = NULL);
  ...
  iDialogObjDiffFilter(QWidget* par_window_);
