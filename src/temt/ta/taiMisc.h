...
public:
  ...
  static taiEditorOfWidgetsClass_List   active_edits;   // #IGNORE list of active edit dialogs
  static taiEditorOfWidgetsClass_List   css_active_edits; // #IGNORE list of css active edit dialogs (note: prev in cssiSession)
...
//  static bool ReShowEdits(void* obj, TypeDef* td, bool force = true);
  ...
  static taiEditorOfWidgetsClass* FindEdit(void* base, iMainWindowViewer* not_in_win = NULL);
  ...
  static taiEditorOfWidgetsClass* FindEditDialog(void* base, bool read_only);
  // find an active (non-modal) edit dialog with same read_only state for the object
  static taiEditorOfWidgetsClass* FindEditPanel(void* base, bool read_only,
