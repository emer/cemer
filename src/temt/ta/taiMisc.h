...
public:
  ...
  enum BoundAction {
    ...
    TEXTEDIT_EMACS_DESELECT,
    TEXTEDIT_EMACS_CLEAR_EXTENDED_SELECTION,
    TEXTEDIT_EMACS_HOME,
    TEXTEDIT_EMACS_END,
    TEXTEDIT_EMACS_CURSOR_FORWARD,
    TEXTEDIT_EMACS_CURSOR_BACKWARD,
    TEXTEDIT_EMACS_DELETE,
    TEXTEDIT_EMACS_BACKSPACE,
    TEXTEDIT_EMACS_KILL,
    TEXTEDIT_EMACS_SELECT_ALL,
    TEXTEDIT_EMACS_PASTE,
    TEXTEDIT_EMACS_CUT,
    TEXTEDIT_EMACS_UNDO,
    TEXTEDIT_EMACS_PAGE_UP,
    TEXTEDIT_EMACS_PAGE_DOWN,
    TEXTEDIT_EMACS_FIND_IN_TEXT,
    TEXTEDIT_EMACS_COPY_CLEAR,
    TEXTEDIT_EMACS_WORD_FORWARD,
    TEXTEDIT_EMACS_WORD_BACKWARD,
    ...
    MAINWINDOW_DELETE,
    MAINWINDOW_VIEW_BROWSE_ONLY,
    MAINWINDOW_VIEW_PANELS_ONLY,
    MAINWINDOW_VIEW_BROWSE_AND_PANELS,
    MAINWINDOW_VIEW_T3_ONLY,
    MAINWINDOW_VIEW_BROWSE_AND_T3,
    MAINWINDOW_VIEW_PANELS_AND_T3,
    MAINWINDOW_VIEW_ALL_FRAMES,
    MAINWINDOW_MOVE_FOCUS_LEFT,
    MAINWINDOW_MOVE_FOCUS_RIGHT,
    MAINWINDOW_SHIFT_CUR_TAB_LEFT,
    MAINWINDOW_SHIFT_CUR_TAB_RIGHT,
