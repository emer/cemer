...
#include "taiWidgetSubGroupEditButton.h"
#include <taGroup_impl>


taiWidgetSubGroupEditButton::taiWidgetSubGroupEditButton
(void* base, const char* nm, TypeDef* tp, IWidgetHost* host_, taiWidget* par, QWidget* gui_parent_, int flags_)
: taiWidgetEditButton(base, NULL, tp, host_, par, gui_parent_, flags_)
{
  label = nm;
}

void taiWidgetSubGroupEditButton::SetLabel() {
