...
TA_API inline void cat(const String& x, const String& y, String& r)
{
  r.setRep(Scat(x.chars(), x.length(), y.chars(), y.length()));
}

TA_API inline void cat(const String& x, const char* y, String& r)
{
  r.setRep(Scat(x.chars(), x.length(), y, -1));
}

TA_API inline void cat(const String& x, const char* y, uint slen, String& r)
{
  r.setRep(Scat(x.chars(), x.length(), y, slen));
}

TA_API inline void cat(const String& x, char y, String& r)
{
  if (y == '\0') r = x;
  else r.setRep(Scat(x.chars(), x.length(), &y, 1));
}

TA_API inline void cat(const char* x, const String& y, String& r)
{
  r.setRep(Scat(x, -1, y.chars(), y.length()));
}

TA_API inline void cat(const char* x, const char* y, String& r)
{
  r.setRep(Scat(x, -1, y, -1));
}

TA_API inline void cat(const char* x, char y, String& r)
{
  if (y == '\0') r = x;
...
TA_API inline String reverse(const String& x)
{
  String r; r.setRep(Sreverse(x.mrep)); return r;
}

TA_API inline String upcase(const String& x)
{
  String r(x); r.upcase(); return r;
}

TA_API inline String downcase(const String& x)
{
  String r(x); r.downcase(); return r;
}

TA_API inline String capitalize(const String& x)
{
