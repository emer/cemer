...
#include "taiEditorWidgetsOfTypeItem.h"
...
taiEditorWidgetsOfTypeItem::taiEditorWidgetsOfTypeItem(TypeItem* ti_, TypeItem::TypeInfoKinds tik_, 
...
void taiEditorWidgetsOfTypeItem::Constr_Data_Labels() {
//  taiData* dat;
