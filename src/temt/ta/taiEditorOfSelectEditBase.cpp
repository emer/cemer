...
taiEditorOfSelectEditBase::taiEditorOfSelectEditBase(void* base, TypeDef* td,
...
taiEditorOfSelectEditBase::~taiEditorOfSelectEditBase() {
}

void taiEditorOfSelectEditBase::Initialize()
{
...
void taiEditorOfSelectEditBase::Constr_Body() {
  if (rebuild_body) {
    meth_el.Reset();
  }
...
void taiEditorOfSelectEditBase::Constr_Methods_impl() {
...
taBase* taiEditorOfSelectEditBase::GetMembBase_Flat(int idx) {
  return sele->mbrs.GetBase_Flat(idx);
}

taBase* taiEditorOfSelectEditBase::GetMethBase_Flat(int idx) {
  return sele->mths.GetBase_Flat(idx);
}


void taiEditorOfSelectEditBase::mnuRemoveMember_select(int idx) {
  sele->RemoveField(idx);
}

void taiEditorOfSelectEditBase::mnuRemoveMethod_select(int idx) {
  sele->RemoveFun(idx);
}
