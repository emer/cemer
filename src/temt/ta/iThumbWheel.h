...
#ifndef iThumbWheel_h
#define iThumbWheel_h 1
...
class QT_QTTHUMBWHEEL_EXPORT iThumbWheel : public QAbstractSlider
{
    Q_OBJECT
...
private:
    Q_DECLARE_PRIVATE(iThumbWheel)
    Q_DISABLE_COPY(iThumbWheel)
    iThumbWheelPrivate *d_ptr;
};
