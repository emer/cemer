...
#ifndef taiEditorWidgetsOfUserData_h
...
//obs  override taBase* GetMethBase_Flat(int idx);
  ...
  taiEditorWidgetsOfUserData(void* base, TypeDef* td, bool read_only_ = false,
        QObject* parent = 0);
  taiEditorWidgetsOfUserData()   { Initialize();};
  ~taiEditorWidgetsOfUserData();
...
#endif // taiEditorWidgetsOfUserData_h
