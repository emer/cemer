...
#ifndef iDialogObjChooser_h
#define iDialogObjChooser_h 1
...
class TA_API iDialogObjChooser : public iDialog {
  ...
  INHERITED(iDialog)
public:
  static iDialogObjChooser* createInstance(taBase* parob, const char* captn, bool selonly = true, QWidget* par_window_ = NULL);
    // create method for lists/groups
  static iDialogObjChooser* createInstance(TypeDef* tpdf, const char* captn, taBase* scope_ref_ = NULL, QWidget* par_window_ = NULL);
  ...
  iDialogObjChooser(taBase* parob, const char* captn, bool selonly, QWidget* par_window_); // USE createInstance instead!!!
  iDialogObjChooser(TypeDef* tpdf, const char* captn, taBase* scope_ref_, QWidget* par_window_); // USE createInstance instead!!!
