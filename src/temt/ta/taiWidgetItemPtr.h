...
#ifndef taiWidgetItemPtr_h
#define taiWidgetItemPtr_h 1
...
typedef bool (*cust_chooser_fun)(taBase*, taiWidgetItemPtr*); // optional custom config, spec'ed in CUST_CHOOSER_xxx

class TA_API taiWidgetItemPtr : public taiWidget {
