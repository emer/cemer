...
#include "taiArgTypeOftaBasePtr.h"
#include <taList_impl>


int taiArgTypeOftaBasePtr::BidForArgType(int aidx, TypeDef* argt, MethodDef* md, TypeDef* td) {
...
cssEl* taiArgTypeOftaBasePtr::GetElFromArg(const char* nm, void* base) {
  ...
  return taiArgTypeOfTokenPtr::GetElFromArg(nm,base);
}
