...
public:
  ...
  taiSigLink* par_link() const override; // taken from dps if any, else from tabview
  MemberDef*   par_md() const override;
  ...
  void         UpdatePanel() override; // we add a test for HasChanged and invoke the inherited
...
public: // ISigLinkClient interface
  ...
  TypeDef*     GetTypeDef() const override {return &TA_iPanel;}
