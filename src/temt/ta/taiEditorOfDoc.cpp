...
taiEditorOfDoc::taiEditorOfDoc(void* base, TypeDef* typ_, bool read_only_,
...
void taiEditorOfDoc::init() {
  tedHtml = NULL;
}

taDoc* taiEditorOfDoc::doc() const {
  return static_cast<taDoc*>(root);
}

void taiEditorOfDoc::Constr_Body() {
  //  taiEditorWidgetsMain::Constr_Body();
}

void taiEditorOfDoc::Constr_Box() {
  // Html tab
  taDoc* doc_ = doc();
...
void taiEditorOfDoc::ClearBody_impl() {

}

void taiEditorOfDoc::GetImage_Membs() {
...
void taiEditorOfDoc::GetValue_Membs() {
...
QWidget* taiEditorOfDoc::firstTabFocusWidget() {
  return tedHtml;
}

bool taiEditorOfDoc::eventFilter(QObject* obj, QEvent* event) {
