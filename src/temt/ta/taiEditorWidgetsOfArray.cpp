...
#include "taiEditorWidgetsOfArray.h"
...
taiEditorWidgetsOfArray::~taiEditorWidgetsOfArray() {
  //anything?
}
...
void taiEditorWidgetsOfArray::Constr_Data_Labels() {
  inherited::Constr_Data_Labels();
  Constr_AryData_Labels();
}

void taiEditorWidgetsOfArray::Constr_AryData_Labels() {
...
/* TODO
int taiEditorWidgetsOfArray::Edit() {
...
void taiEditorWidgetsOfArray::GetValue_Membs() {
