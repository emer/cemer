...
#ifndef taiWidgetTypeDefPtr_h
#define taiWidgetTypeDefPtr_h 1
...
class TA_API taiWidgetTypeDefPtr : public taiWidgetItemPtr {
  // for TypeDefs
...
public:
  ...
  taiWidgetTypeDefPtr(TypeDef* typ_, IWidgetHost* host,
