...
public:
  ...
  const MatrixGeom& cellGeom() const override {return cell_geom;}
  bool         usesCellNames() const override {return uses_cell_names;}
  const String_Matrix& cellNames() const override {return cell_names;}
