...
#ifndef iSynchronousNetRequest_h
#define iSynchronousNetRequest_h 1
...
class iSynchronousNetRequest : public QObject
{
  Q_OBJECT

public:
  iSynchronousNetRequest(QNetworkAccessManager *qnam = 0);
  virtual ~iSynchronousNetRequest();
...
#endif // iSynchronousNetRequest_h
