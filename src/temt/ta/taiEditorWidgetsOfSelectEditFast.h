...
#ifndef taiEditorWidgetsOfSelectEditFast_h
#define taiEditorWidgetsOfSelectEditFast_h 1
...
class TA_API taiEditorWidgetsOfSelectEditFast : public taiEditorWidgetsOfSelectEditBase {
...
public:
  ...
  taiEditorWidgetsOfSelectEditFast(void* base, TypeDef* td, bool read_only_ = false,
        QObject* parent = 0);
  taiEditorWidgetsOfSelectEditFast()        { Initialize();};
  ~taiEditorWidgetsOfSelectEditFast();
...
#endif // taiEditorWidgetsOfSelectEditFast_h
