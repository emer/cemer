...
public:
  ...
  const iColor GetEditColorInherit(taiSigLink* dl, bool& ok) const override;// #IGNORE background color for edit
  iPanelBase*  CreateDataPanel(taiSigLink* dl_) override;
