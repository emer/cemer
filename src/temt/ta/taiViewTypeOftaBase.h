...
public:
  ...
  const iColor GetEditColorInherit(taiSigLink* dl, bool& ok) const CPP11_OVERRIDE;// #IGNORE background color for edit
  iPanelBase*  CreateDataPanel(taiSigLink* dl_) CPP11_OVERRIDE;
