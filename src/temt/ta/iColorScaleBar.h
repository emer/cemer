...
#ifndef iColorScaleBar_h
#define iColorScaleBar_h 1
...
public:
  ...
  iColorScaleBar(bool hor, SpanMode sm, bool adj, bool ed, QWidget* parent = NULL);
  virtual ~iColorScaleBar();
