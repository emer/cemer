...
#ifndef T3TabViewer_h
#define T3TabViewer_h 1
...
class T3Panel; //
class iT3TabViewer; //  #IGNORE
class iTabBarBase; //  #IGNORE
class T3DataView; //


TypeDef_Of(T3TabViewer);

class TA_API T3TabViewer : public FrameViewer {
...
public:
  ...
  void  InitLinks();
  void  CutLinks();
  void  Copy_(const T3TabViewer& cp);
  TA_DATAVIEWFUNS(T3TabViewer, FrameViewer)
