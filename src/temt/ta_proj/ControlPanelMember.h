...
public:
  ...
  bool                  search;         // #CONDSHOW_ON_ctrl_type:CLUSTER_RUN&&is_single&&is_numeric Use this parameter in a parameter search function, with values that are specified in range -- only applies when a search algorithm is also selected!  automatically records this parameter as well because it will be set by the command line and is NOT the same as that saved with the project
