...
public:
  enum DiffFlags {              // #BITS
    ...
    ACT_DEL_A   = 0x001000,     // action: delete obj from a
    ACT_DEL_B   = 0x002000,     // action: delete obj from b
    ACT_ADD_A   = 0x004000,     // action: add obj to a after last b
    ACT_ADD_B   = 0x008000,     // action: add obj to b after last a
    ACT_COPY_AB = 0x010000,     // action: copy from a to paired diff_odr b
    ACT_COPY_BA = 0x020000,     // action: copy from paired diff_odr b to a
