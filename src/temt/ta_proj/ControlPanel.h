...
class TA_API ControlPanel: public taNBase, public virtual IRefListClient {
  // #AKA_SelectEdit #STEM_BASE ##EXT_edit ##EXPAND_UNDER_DEF_1 ##CAT_Display A user-customizable panel of parameters and functions from anywhere in the project, that are most important for controlling the simulation
  INHERITED(taNBase)
public:
