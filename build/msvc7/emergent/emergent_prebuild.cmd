...
nmake /f %EMERGENTDIR%\build\Makefile "TARGET=%1" network_files
@if errorlevel 1 goto end

@cd %EMERGENTDIR%\src\emergent\cs
nmake /f %EMERGENTDIR%\build\Makefile "TARGET=%1" cs_files
@if errorlevel 1 goto end

@cd %EMERGENTDIR%\src\emergent\bp
nmake /f %EMERGENTDIR%\build\Makefile "TARGET=%1" bp_files
@if errorlevel 1 goto end

@cd %EMERGENTDIR%\src\emergent\leabra
nmake /f %EMERGENTDIR%\build\Makefile "TARGET=%1" leabra_files
@if errorlevel 1 goto end

@cd %EMERGENTDIR%\src\emergent\so
nmake /f %EMERGENTDIR%\build\Makefile "TARGET=%1" so_files
@if errorlevel 1 goto end
