...
path C:\Qt\Qt5.6.1\msvc2015_64\plugins\platforms;C:\Program Files (x86)\CMake\bin;C:\Subversion;C:\jom_1_1_1;C:\cygwin64\bin;%QTDIR%\bin;%COINDIR%\bin;%EMER_MISC_LIBS_DIR%\bin;%EMER_SVN_LIBS_DIR%;%EMER_SVN_LIBS_DIR%\bin;C:\Windows\system32;%PATH%
