#ifndef QT3D_EXAMINER_VIEWER_H
#define QT3D_EXAMINER_VIEWER_H
...
// Modified to use Qt3D by T. Mankad 2015
...
// the only dependencies are Qt and Qt3D
...
public:
  ...
  QVector3D	eye;		// position of the camera
  QVector3D	up_vector;	// rotation axis
  QVector3D center;
  Qt3D::QCamera   m_saved_camera;
...
class Qt3DExaminerViewer : public QWidget {
  ...
  Q_OBJECT
public:
  Qt3DExaminerViewer(QWidget * parent = 0);
  ~Qt3DExaminerViewer();
  ...
  virtual void    setViewerCamera(Qt3D::QCamera *camera) {
    m_camera = camera;
  }
  virtual Qt3D::QCamera*  	getViewerCamera();
  ...
  virtual QWindow*  Get_window() { return m_qview; }
